...
{
    id: "gyromitra-caroliniana",
    scientificName: "Gyromitra caroliniana",
    commonName: "Carolina False Morel",
    aliases: ["Big Red", "Carolina Gyromitra"],
    synonyms: [],
    taxonomy: { kingdom: "Fungi", phylum: "Ascomycota", class: "Pezizomycetes", order: "Pezizales", family: "Discinaceae", genus: "Gyromitra", species: "caroliniana" },
    edibility: "toxic",
    ecology: "saprotrophic",
    habitat: "Hardwood forests, especially under oaks and elms; spring fruiting",
    naRange: "Eastern North America from Quebec south to Georgia and west to the Great Plains",
    morphology: { capShape: "Large brain-like, wrinkled reddish-brown to saddle-shaped cap on a thick ribbed stipe", gillAttachment: "None (ascomycete)", sporeColor: "White", hasRing: false, hasVolva: false },
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4a/Gyromitra_caroliniana_44297.jpg/500px-Gyromitra_caroliniana_44297.jpg",
    imageAttribution: "© Wikimedia Commons contributors / CC BY-SA",
    crossSectionUrl: null,
    gbifId: 3077753,
    rarity: 35,
    fame: 40,
    difficulty: "hard",
    funFact: "Contains gyromitrin, which metabolizes in the body to monomethylhydrazine — the same compound used as rocket fuel — causing liver failure and hemolysis.",
  },
{
    id: "laetiporus-cincinnatus",
    scientificName: "Laetiporus cincinnatus",
    commonName: "White-Pored Chicken of the Woods",
    aliases: ["Chicken of the Woods", "Sulphur Shelf"],
    synonyms: [],
    taxonomy: { kingdom: "Fungi", phylum: "Basidiomycota", class: "Agaricomycetes", order: "Polyporales", family: "Polyporaceae", genus: "Laetiporus", species: "cincinnatus" },
    edibility: "edible",
    ecology: "parasitic",
    habitat: "Base of oaks and other hardwoods; grows from roots or buried wood",
    naRange: "Eastern North America",
    morphology: { capShape: "Overlapping orange-yellow bracket shelves with white to pale pores underneath", gillAttachment: "None (polypore)", sporeColor: "White", hasRing: false, hasVolva: false },
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8b/Laetiporus_sulphureus_JPG01.jpg/500px-Laetiporus_sulphureus_JPG01.jpg",
    imageAttribution: "© Wikimedia Commons contributors / CC BY-SA",
    crossSectionUrl: null,
    gbifId: 5219654,
    rarity: 30,
    fame: 55,
    difficulty: "medium",
    funFact: "Distinguished from L. sulphureus by its white (not yellow) pores and growth at the base of oaks rather than high on the trunk — and it causes fewer GI reactions in sensitive individuals.",
  },
{
    id: "morchella-americana",
    scientificName: "Morchella americana",
    commonName: "American Morel",
    aliases: ["Yellow Morel", "Common Morel"],
    synonyms: ["Morchella esculentoides"],
    taxonomy: { kingdom: "Fungi", phylum: "Ascomycota", class: "Pezizomycetes", order: "Pezizales", family: "Morchellaceae", genus: "Morchella", species: "americana" },
    edibility: "choice",
    ecology: "saprotrophic",
    habitat: "Hardwood forests, old orchards, disturbed areas; spring fruiting under elms, ash, and apple trees",
    naRange: "Widespread across eastern and central North America; one of the most common yellow morels",
    morphology: { capShape: "Honeycomb-pitted conical cap fused to hollow stipe at base", gillAttachment: "None (ascomycete)", sporeColor: "Cream", hasRing: false, hasVolva: false },
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/dc/Morchella_americana_closer.JPG/500px-Morchella_americana_closer.JPG",
    imageAttribution: "© Wikimedia Commons contributors / CC BY-SA",
    crossSectionUrl: null,
    gbifId: 7228378,
    rarity: 20,
    fame: 80,
    difficulty: "easy",
    funFact: "Only formally described as a distinct species in 2012 via DNA analysis — for centuries it was lumped under the European Morchella esculenta, which doesn't actually occur in North America.",
  },
{
    id: "cantharellus-cinnabarinus",
    scientificName: "Cantharellus cinnabarinus",
    commonName: "Cinnabar Chanterelle",
    aliases: ["Red Chanterelle"],
    synonyms: [],
    taxonomy: { kingdom: "Fungi", phylum: "Basidiomycota", class: "Agaricomycetes", order: "Cantharellales", family: "Cantharellaceae", genus: "Cantharellus", species: "cinnabarinus" },
    edibility: "edible",
    ecology: "mycorrhizal",
    habitat: "Hardwood forests with oaks and beech; midsummer through fall",
    naRange: "Eastern North America",
    morphology: { capShape: "Small brilliant cinnabar-red to orange-red cap with forking false gills of the same colour", gillAttachment: "Decurrent false gills", sporeColor: "Salmon-pink", hasRing: false, hasVolva: false },
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9b/Cantharellus_cinnabarinus.jpg/500px-Cantharellus_cinnabarinus.jpg",
    imageAttribution: "© Wikimedia Commons contributors / CC BY-SA",
    crossSectionUrl: null,
    gbifId: 2551016,
    rarity: 30,
    fame: 45,
    difficulty: "medium",
    funFact: "The most strikingly coloured North American chanterelle — its brilliant cinnabar-red is unlike any toxic lookalike, making it one of the safer beginner chanterelles to identify.",
  },
{
    id: "imleria-badia",
    ...
    aliases: ["Bay Porcini"],
    synonyms: ["Boletus badius", "Xerocomus badius"],
    taxonomy: { kingdom: "Fungi", phylum: "Basidiomycota", class: "Agaricomycetes", order: "Boletales", family: "Boletaceae", genus: "Imleria", species: "badia" },
    edibility: "edible",
    ecology: "mycorrhizal",
    habitat: "Coniferous and mixed forests; associates with pines and spruces",
    naRange: "Northern and western North America; more common in Europe but established widely",
    morphology: { capShape: "Bay-brown to chestnut convex cap; yellow pores that slowly blue when bruised; slender stipe", gillAttachment: "None (bolete)", sporeColor: "Olive-brown", hasRing: false, hasVolva: false },
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/Boletus_badius_JPG1.jpg/500px-Boletus_badius_JPG1.jpg",
    imageAttribution: "© Wikimedia Commons contributors / CC BY-SA",
    crossSectionUrl: null,
    gbifId: 7101506,
    rarity: 25,
    fame: 35,
    difficulty: "hard",
    funFact: "One of the few boletes that retains its bluing reaction even after cooking, and it absorbs caesium-137 from contaminated soils more efficiently than almost any other edible mushroom.",
  },
{
    id: "ganoderma-tsugae",
    scientificName: "Ganoderma tsugae",
    commonName: "Hemlock Varnish Shelf",
    aliases: ["Hemlock Reishi", "Ling Zhi"],
    synonyms: [],
    taxonomy: { kingdom: "Fungi", phylum: "Basidiomycota", class: "Agaricomycetes", order: "Polyporales", family: "Ganodermataceae", genus: "Ganoderma", species: "tsugae" },
    edibility: "inedible",
    ecology: "parasitic",
    habitat: "Eastern hemlock (Tsuga canadensis) and other conifers; causes white heart rot",
    naRange: "Eastern North America, especially the Appalachians and northeastern US",
    morphology: { capShape: "Kidney-shaped shelf with a glossy lacquered red-brown varnished surface; white to cream pores underneath", gillAttachment: "None (polypore)", sporeColor: "Brown", hasRing: false, hasVolva: false },
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/af/Ganoderma_tsugae.jpg/500px-Ganoderma_tsugae.jpg",
    imageAttribution: "© Wikimedia Commons contributors / CC BY-SA",
    crossSectionUrl: null,
    gbifId: 5459086,
    rarity: 30,
    fame: 55,
    difficulty: "medium",
    funFact: "The North American counterpart to the legendary medicinal Ganoderma lucidum (Reishi) — used for millennia in traditional medicine and now studied for immune-modulating triterpenoids.",
  },
{
    id: "tylopilus-felleus",
    scientificName: "Tylopilus felleus",
    commonName: "Bitter Bolete",
    aliases: ["False Porcini", "Gall Bolete"],
    synonyms: [],
    taxonomy: { kingdom: "Fungi", phylum: "Basidiomycota", class: "Agaricomycetes", order: "Boletales", family: "Boletaceae", genus: "Tylopilus", species: "felleus" },
    edibility: "inedible",
    ecology: "mycorrhizal",
    habitat: "Coniferous and mixed forests with oaks, pines, and hemlocks",
    naRange: "Widespread across eastern North America",
    morphology: { capShape: "Brown convex cap; rosy-pink to dirty-pink pores; thick stipe with coarse reticulation", gillAttachment: "None (bolete)", sporeColor: "Pink-brown", hasRing: false, hasVolva: false },
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e3/2006-09-14_Tylopilus_felleus_crop.jpg/500px-2006-09-14_Tylopilus_felleus_crop.jpg",
    imageAttribution: "© Wikimedia Commons contributors / CC BY-SA",
    crossSectionUrl: null,
    gbifId: 5220143,
    rarity: 25,
    fame: 40,
    difficulty: "hard",
    funFact: "A single small piece of Bitter Bolete can ruin an entire pot of soup — the intensely bitter taste (from fellein compounds) is not destroyed by cooking and is detectable at extraordinary dilutions.",
  },
{
    id: "laccaria-amethystina",
    scientificName: "Laccaria amethystina",
    commonName: "Amethyst Deceiver",
    aliases: ["Amethyst Laccaria"],
    synonyms: [],
    taxonomy: { kingdom: "Fungi", phylum: "Basidiomycota", class: "Agaricomycetes", order: "Agaricales", family: "Hydnangiaceae", genus: "Laccaria", species: "amethystina" },
    edibility: "edible",
    ecology: "mycorrhizal",
    habitat: "Deciduous and coniferous forests; often in leaf litter under beech, oak, and conifers",
    naRange: "Widespread across North America",
    morphology: { capShape: "Small vivid purple to violet convex cap fading to buff when dry; thick purple gills; fibrous purple stipe", gillAttachment: "Adnate to slightly decurrent", sporeColor: "White", hasRing: false, hasVolva: false },
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/bd/Laccaria_amethystina_LC0370.jpg/500px-Laccaria_amethystina_LC0370.jpg",
    imageAttribution: "© Wikimedia Commons contributors / CC BY-SA",
    crossSectionUrl: null,
    gbifId: 2533006,
    rarity: 25,
    fame: 50,
    difficulty: "medium",
    funFact: "Called 'Deceiver' because it changes appearance dramatically as it dries — the brilliant violet fades to a dull buff-tan, making fresh and dry specimens look like completely different species.",
  },
];
